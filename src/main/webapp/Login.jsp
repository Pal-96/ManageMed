...
<nav class="navbar navbar-expand-lg navbar-light w-100" style="border-bottom: 2px solid grey">
      <div class="container">
         <a class="navbar-brand" href="Welcome.jsp"><img src="assets/images/pills-solid.svg" alt="" width="30"
		...
		<div class="container container-login">
			<div class="row">
				...
				<div class="card shadow-sm col container-login mb-6">
                        ...
                        <a href="Register.jsp" class="text-primary">Register here</a></p>
                        
                        
                     </div>
                           <form action="test" method="post" class="needs-validation placement-login" novalidate="">
                              <div class="mb-4">
